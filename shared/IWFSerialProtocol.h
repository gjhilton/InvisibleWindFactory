...
const char COMMAND_DELIMITER_TEMPO = 'o';
const char COMMAND_DELIMITER_DITTO = '"';

const char COMMAND_DELIMITER_AUDIO_TRACK = 'a';
const char COMMAND_DELIMITER_AUDIO_STOP = 'f';
const char COMMAND_DELIMITER_AUDIO_VOLUME = 'v';